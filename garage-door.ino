...
const char* ssid = "<your sid>";  // CHANGE: Wifi name
const char* password = "<your password>";  // CHANGE: Wifi password 
String friendlyName = "Garage Door with Sensor";        // CHANGE: Alexa device name
const int trigPin = D5;
const int echoPin = D6;
const int relayPin = D7;  // D1 pin. More info: https://github.com/esp8266/Arduino/blob/master/variants/d1_mini/pins_arduino.h#L49-L61
...
void setup() {
  Serial.begin(115200);
  delay(10);
  // Setup Relay and ultrasonic sensor
...
void startHttpServer() {
    ...
    HTTP.on("/on.html", HTTP_GET, [](){
         ...
         tripWire.setInterval(1000, turnOnRelay);
     ...
     HTTP.on("/off.html", HTTP_GET, [](){
        ...
        tripWire.setInterval(1000, turnOffRelay);
        digitalWrite(relayPin, LOW);
       });
